  ...
  return (
    <div className="auth-layout">
      <div className="auth-left">
        ...
        <p>Crea tu cuenta y gestiona las citas de tus mascotas</p>
      ...
      <div className="auth-right">
        <div className="auth-card">
          ...
          <p>Únete y gestiona las citas de tus mascotas</p>
          ...
          <div style={{ textAlign: "center", display: "grid", gap: 12 }}>
            <span style={{ fontSize: 14, color: "#7a7672" }}>
              ¿Ya tienes cuenta? <a className="link-text" href="/login">Inicia sesión</a>
            </span>
